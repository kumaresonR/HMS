...
const EditCertificateTemplate = () => {
    ...
    const createTemplate = async () => {
        try {
            ...
            formData.append('CertificateTemplateId',id);
            ...
            await certificateApiService.editCertificateTemplate(formData);
            toast.success("Template Updated Successfully", { containerId: "TR" });
    ...
    const setTemplateData = (data: any) => {
        setCertificateTemplateName(data.CertificateTemplateName);
        setHeaderLeftText(data.HeaderLeftText);
        setHeaderRightText(data.HeaderRightText);
        setHeaderCenterText(data.HeaderCenterText);
        setBodyText(data.BodyText);
        setFooterLeftText(data.FooterLeftText);
        setFooterRightText(data.FooterRightText);
        setFooterCenterText(data.FooterCenterText);
        setHeaderHeight(data.HeaderHeight);
        setFooterHeight(data.footerHeight);
        setContentHeight(data.ContentHeight);
        setContentWidth(data.ContentWidth);
        setIsActivePatientImage(data.IsActivePatientImage);
        setPhotoHeight(data.PhotoHeight);
    ...
    return (
        <React.Fragment>
            <div>
                <Container fluid>
                    <FormHeader title="Edit Certificate Template"
                        pageTitle="Certificate"
                        onMinimize={() => dispatch(minimizePage({
                            route: location.pathname,
                            pageName: "Edit Certificate Template",
                            // data
                        }))} />
                    <Row>
                        <Col lg={12}>
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="d-flex justify-content-between align-items-center mb-3">
                                                <h5 className="mb-0">Edit Certificate Template</h5>
                                                <Link to="/main/CertificateTemplateDataTable" className="text-end">
                                                    <Button
                                                        color="primary"
