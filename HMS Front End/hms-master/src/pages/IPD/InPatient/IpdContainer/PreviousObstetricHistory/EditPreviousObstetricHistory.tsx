...
const EditPreviousObstetricHistory = (props: any) => {
    ...
    const doCreate = async () => {
        try {
            ...
            await ipdApiService.editPreviousObstetricHistory(props.data.historyId, payload);
    ...
    const getObstertricById = async () => {
        try {
            let data = await ipdApiService.getPreviousObstetricHistoryById(props.data.historyId);
            setObstericData(data);
    ...
    const setObstericData = (data: any) => {
        setIpdId(data.ipdId);
        setPlaceOfDelivery(data.placeOfDelivery);
        setDurationOfPregnancy(data.durationOfPregnancy);
        setComplicationInPregnancyOrPuerperium(data.complicationsInPregnancyOrPuerperium);
        setBirthWeight(data.birthWeight);
        setGender(data.gender);
        setInfantFeeding(data.infantFeeding);
        setBirthStatus(data.birthStatus);
        setDeathCause(data.deathCause);
        setAliveOrDeadDate(data.aliveOrDeadDate);
...
export default EditPreviousObstetricHistory