...
const ViewRadiologyIncome = () => {
    ...
    const getAllIncome = async (selectedFilter: any) => {
        try {
            ...
            let ipdIncome = await dashboardApiService.getAllRadiologyIncome(url);
            setData(ipdIncome)
        } catch (error: any) {
            console.log(error);
            setData([])
...
export default ViewRadiologyIncome