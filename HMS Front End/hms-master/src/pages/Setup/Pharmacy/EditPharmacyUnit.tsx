...
const EditPharmacyUnit = () => {
  const setupApiService: SetupApiService = new SetupApiService();
    ...
    const editRaiologyunit = async () => {
        try {
            const payload: any = {
                // modNo: modNo,
                unitName: unitsName,
            }
            await setupApiService.editUnit(data.id,payload);
                            ...
                            <Row className="d-flex justify-content-center">
                                <Col xl={12}>
                                    <Form onSubmit={handleSubmit}>
                                        ...
                                        <Button type="submit" color="primary">Update Units</Button>
                                    </Form>
                                </Col>
                            </Row>
                        </CardBody>
...
export default EditPharmacyUnit