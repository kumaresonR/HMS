...
const System = () => {
    ...
    const handleToggle = (id: number) => {
        const updatedData = SystemData.map((item) =>
            item.id === id ? { ...item, isActive: !item.isActive } : item
        );
        setSystemData(updatedData); // Update state with the new data
        console.log(`Toggled System entry with id: ${id}`);
