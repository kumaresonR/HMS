...
const AddChargeType = () => {
    ...
    const createChargesType = async () => {
        try {
            ...
            await setupApiService.createChargesType(payload);
            navigate('/main/hospitalMain');
            toast.success('Charge Type Added Successfully', { containerId: 'TR' });
        } catch (error: any) {
    ...
    return (
        <React.Fragment>
            <div>
                <Container fluid>
                    <FormHeader title="Add Charge Type" pageTitle="Setup" />
                    <Card>
                        <CardBody>
