...
const AddDepartment = () => {
    ...
    const createDepartment = async () => {
        try {
            ...
            await setupApiService.createDepartment(payload);
            navigate('/main/humanResourceMainSetup');
            toast.success('Department Added Successfully', { containerId: 'TR' });
        } catch (error: any) {
    ...
    return (
        <React.Fragment>
            <div>
                <Container fluid>
                    <FormHeader title="Add Department" pageTitle="Setup" />
                    <Card>
                        <CardBody>
