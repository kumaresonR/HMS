...
const AddDesignation = () => {
  ...
  const createDesignation = async () => {
      try {
          ...
          await setupApiService.createDesignation(payload);
          navigate('/main/humanResourceMainSetup');
          toast.success('Designation Added Successfully', { containerId: 'TR' });
      } catch (error: any) {
  ...
  return (
      <React.Fragment>
          <div>
              <Container fluid>
                  <FormHeader title="Add Designation" pageTitle="Setup" />
                  <Card>
                      <CardBody>
