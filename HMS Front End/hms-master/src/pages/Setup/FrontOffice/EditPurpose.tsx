...
const EditPurpose = () => {
    ...
    const editComplainType = async () => {
        try {
            ...
            await setupApiService.editPurpose(data.id, payload);
            navigate('/main/frontofficeMain');
            toast.success('Purpose Updated Successfully', { containerId: 'TR' });
        } catch (error: any) {
    ...
    return (
        <React.Fragment>
            <div>
                <Container fluid>
                    <FormHeader title="Edit Purpose" pageTitle="Setup" />
                    <Card>
                        <CardBody>
