...
const EditReferralCommission = () => {
    ...
    const addReferralPerson = async () => {
        try {
            ...
            await setupApiService.editCommission(data.commissionId, payload);
            toast.success("Referral Commission Updated Successfully", { containerId: "TR" });
    ...
    return (
        <React.Fragment>
            <div>
                <Container fluid>
                    <FormHeader title="Edit Referral Commission" pageTitle="Settup" />
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <CardBody>
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            <div className="d-flex justify-content-between align-items-center mb-3">
                                                <h5 className="mb-0">Edit Refferal Commission Details</h5>
...
export default EditReferralCommission