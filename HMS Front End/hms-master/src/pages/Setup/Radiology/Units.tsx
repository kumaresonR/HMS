...
const UnitList = () => {
        ...
        if (selectedUnitId) {
            ...
            try {
                if (status === "AUTHORIZED") {
                    await setupApiService.approveRaiologyUnit(selectedUnitId);
                    toast.success('Record has been Authorized Successfully', { containerId: 'TR' });
                } else {
                    await setupApiService.disApproveRaiologyUnit(selectedUnitId);
                    toast.success('Record has been approved UnAuthorized Successfully', { containerId: 'TR' });
                }
                await getAllRaiologyUnitWorkTable();
    ...
    const editUnit = (data: any) => {
        navigate('/main/editRadiologyUnits', { state: { data: data } })
    }
    ...
    const handleDelete = async () => {
        if (selectedId) {
            try {
                await setupApiService.deleteRaiologyUnit(selectedId);
    ...
    const getAllRaiologyUnitWorkTable = async () => {
        try {
            let result = await setupApiService.getAllRaiologyUnitWorkTable();
            setUnitData(result);
        } catch (error: any) {
            return ErrorHandler(error)
        }
                                            ...
                                            <CardHeader className="border-0">
                                                <Row className="g-4 align-items-center">
                                                    ...
                                                    <div className="col-sm-auto">
                                                        <div>
                                                            <Link to='/main/addRadiologyUnits'>
                                                                <Button
                                                                    size="sm"
                                                                    color="primary"
