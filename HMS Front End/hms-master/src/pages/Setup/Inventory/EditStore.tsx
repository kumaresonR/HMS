...
const EditStore = () => {
  ...
  const editItemStore = async () => {
    try {
      ...
      await setupApiService.editItemStore(data.id,payload);
      toast.success('Store Details Updated Successfully', { containerId: 'TR' });
  ...
  const setData = (data: any) => {
    setItemStoreName(data.itemStoreName);
    setDescription(data.description);
    // setModNo(data.modNo);
    setItemStockCode(data.itemStockCode);
  }
  ...
  return (
    <React.Fragment>
      <div>
        <Container fluid>
          <FormHeader title="Edit Item Store" pageTitle="Setup" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
                  <div className="row">
                    <div className="col-12">
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        <h5 className="mb-0">Edit Item Store </h5>
