...
const EditPathologyBill = (props: any) => {
    ...
    const getAllPathologyBill = async () => {
        try {
            let id = props.data.billId
            let result = await billingApiService.getPathologyBillById(id);
            console.log("getAllPathologyBill", result);
            setPathologyData(result);
        } catch (error: any) {
            console.log("getAllPathologyBill Error");
            console.log(error);
        }
    }

    const setPathologyData = (data: any) => {
        const updatedRows = data.pathologyItems.map((item: any) => {
            return {
                ...item,
            };
        });
...
export default EditPathologyBill