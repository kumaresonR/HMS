...
import { Label, Input, Button, Form, FormGroup, Card, Col, Container, Row, CardBody, Spinner } from 'reactstrap';
...
const AddCalendar: React.FC = () => {
    ...
    const addAnualCalender = async () => {
        try {
            ...
            await anualCalenderApiService.createAnualCalender(payload);
            toast.success('Record Added Successfully', { containerId: 'TR' });
                ...
                <Container fluid>
                    <FormHeader
                        ...
                        onMinimize={() => dispatch(minimizePage({
                            ...
                            pageName: "Add Calendar",
                            data: { type, fromDate, toDate, date, description, title }
                        }))} />
                    <Card>
                        <CardBody>
                            <div className="d-flex justify-content-between align-items-center mb-3">
                                <h5 className="mb-0">Add Calender</h5>
