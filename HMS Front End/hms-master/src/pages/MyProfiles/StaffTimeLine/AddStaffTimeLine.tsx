...
import GetStaffTimeLine from "./GetStaffTimeLine";

const AddStaffTimeLine = (props: any) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            console.log("timelineData", payload)
            const jsonBlob = new Blob([JSON.stringify(payload)], { type: 'application/json' });
            formData.append('timelineData', jsonBlob);
            formData.append('document', documentFile);
            await employeeApiService.createTimeline(formData);
    ...
    //     try {
    //         let result = await employeeApiService.getAllTimeline('all');
    //         console.log("getAllTimeline", result);
    //         setTimeLineData(result);
    //     } catch (error: any) {
    //         console.log("getAllTimeline Error");
    //         console.log(error);
    //         return ErrorHandler(error)
    //     }
    // }
        ...
        <Container fluid>
            <Card>
                <CardBody>
                    ...
                    <Row className="py-3">
                        <GetStaffTimeLine data={props.data.tmTimelines} refresh={props.refresh} />
                    </Row>
                </CardBody>
            </Card>
...
export default AddStaffTimeLine