...
const EditRadiologyCommission = (props: any) => {
  ...
  const validateForm = () => {
    ...
    //   setCommissionPercentageError(true);
    //   isFormValid = false;
    // }
  ...
  const editCommission = async () => {
    try {
      const payload = {
        ...
        doctorId: doctorId,
        dateTime: dateTime,
        commissionCategory: "Radiology",
        // commissionPercentage: commissionPercentage,
        commissionAmount: commissionAmount
      };
      await billingApiService.editRadiologyCommission(props?.data?.id, payload);
...
export default EditRadiologyCommission