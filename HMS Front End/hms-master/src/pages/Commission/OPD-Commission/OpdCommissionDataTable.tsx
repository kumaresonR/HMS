...
import EditOpdCommission from './EditOpdCommission';
import OPDApiService from '../../../helpers/services/opd/opd-api-service';
import AddOpdCommission from './AddOpdCommission';

const OpdCommissionDataTabe = () => {
    ...
    const handleDelete = async () => {
        if (selectedId) {
            try {
                await opdApiService.deleteCommission(selectedId);
    ...
    const getAllCommission = async () => {
        try {
            let result = await opdApiService.getAllCommission();
                        ...
                        <li className="list-inline-item">
                            <Link
                                ...
                                onClick={(e) => {
                                    ...
                                    showModal({
                                        content: (
                                            <EditOpdCommission data={cell.row.original} refresh={getAllCommission} />
                                        ),
                                        title: "Edit OPD Commission",
                                        size: "lg",
                                    })
                                }}
                                title="Edit"
        ...
        <React.Fragment>
            <div>
                <Container fluid>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card id="opdCommission">
                                <CardHeader className="border-0">
                                    <Row className="g-4 align-items-center">
                                        <div className="col-sm">
                                            <div>
                                                <h5 className="card-title mb-0">OPD Commission</h5>
                                            </div>
                                        </div>
                                        <div className="col-sm-auto">
                                            <div>
                                                ...
                                                <Button onClick={() =>
                                                    showModal({
                                                        content: (
                                                            <AddOpdCommission refresh={getAllCommission} />
                                                        ),
                                                        title: "Add OPD Commission",
                                                        size: "lg",
                                                    })
                                                }
                                                ...
                                                >
                                                    <i className="ri-add-fill me-1 align-bottom"></i> Add OPD Commission
                                                </Button>
                                                {/* </RoleBasedComponent> */}
                                            </div>
                                        </div>
...
export default OpdCommissionDataTabe;