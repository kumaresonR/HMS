...
const BloodBankPayment = (props: any) => {
    ...
    const doUpdate = async () => {
        try {
            ...
            if (props.title === 'component-issue') {
                await bloodBankApiService.editComponentIssue(props.data.issueComponentId, formData);
            } else {
                // await bloodBankApiService.editPathologyBill(props.data.billId, formData);
            }
...
export default BloodBankPayment