...
import com.hms.services.ipdmanagement.entity.HMS_TM_Commission;
import com.hms.services.ipdmanagement.model.CommissionDTO;
import com.hms.services.ipdmanagement.service.CommissionService;
...
public class IPDCommissionController {
    ...
    // Create a new record
    @PostMapping
    public ResponseEntity<HMS_TM_Commission> createCommission(@RequestBody HMS_TM_Commission commission) {
    ...
    public ResponseEntity<HMS_TM_Commission> updateCommission(
            ...
            @RequestBody HMS_TM_Commission updatedCommission
    ) {
