...
const AddTestDetails = (props: any) => {
    ...
    const doCreateTestData = async () => {
        try {
            ...
            await billingApiService.createPathologyTest(payload);
            toast.success('Pathology Test Created Successfully', { containerId: 'TR' });
            props.handleClose();
        } catch (error: any) {
                                ...
                                <Row key={index} className='align-items-center'>
                                    ...
                                    <Col xs="auto pt-2">
                                        {index !== 0 && (
                                            ...
                                            <button onClick={() => removeTestData(index)} className="btn btn-soft-danger "> <FontAwesomeIcon
                                                className="mx-2 "
                                                icon={faXmark}
                                            /> </button>
