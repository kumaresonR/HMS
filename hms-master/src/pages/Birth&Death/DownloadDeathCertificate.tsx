...
const DownloadDeathRecord = (props: any) => {
            ...
            <div ref={printRef}>
                <div id="death">
                    <div style={styles.certificate}>
                        ...
                        <div style={styles.downloadBirthCertificateMain} className="card-headermain">
                        ...
                        <div style={styles.header}>
                            <div style={styles.titleSection}>
                                <h1 style={styles.title}>Death Certificate</h1>
                                <p style={styles.subtitle}>Official Record of Death Registration</p>
                            </div>
                            <div style={styles.certificateIdTag}>
                                <span style={styles.idIcon}></span>
                                <span>{props.data.deathId}</span>
                            </div>
                        </div>
                        ...
                        <div style={styles.mainContent}>
                            <div style={styles.section}>
                                ...
                                <div style={styles.infoRow}>
                                    ...
                                    <div style={styles.valueHighlight}>{props.data.patientName}</div>
                                </div>

                                <div style={styles.infoRow}>
                                    <span style={styles.label}>Guardian's Name</span>
                                    <div style={styles.value}>{props.data.guardianName}</div>
                                </div>

                                <div style={styles.infoRow}>
                                    <span style={styles.label}>Date of Death</span>
                                    <div style={styles.value}>
                                        {moment(props.data.dateOfDeath).format("DD MMMM YYYY")}
                                    </div>
                                </div>

                                <div style={styles.infoRow}>
                                    <span style={styles.label}>IPD/OPD ID</span>
                                    <div style={styles.value}>{props.data.ipdOrOpdId || "N/A"}</div>
                                </div>
                                ...
                                {/* {props.data.attachment && (
                                    <div style={styles.infoRow}>
                                        <span style={styles.label}>Attached Document</span>
...
export default DownloadDeathRecord;
