...
const AddDeathRecord = () => {
    ...
    const data = {
        patientName, deathDate, guardianName, report, caseId, selectedFile
    }
    ...
    const addDeathRecord = async () => {
        try {
            ...
            await birthDeathRecordApiService.createDeathRecord(formData);
            toast.success('Death Record Added Successfully', { containerId: 'TR' });
    ...
    useEffect(() => {
        if (location?.state) {
            ...
            setDeathDate(location?.state?.deathDate);
            setGuardianName(location?.state?.guardianName);
    ...
    return (
        <React.Fragment>
            <div>
                <Container fluid>
                    <FormHeader title="Add Death Details"
                        pageTitle="Birth & Deah Records"
                        onMinimize={() => dispatch(minimizePage({
                            route: location.pathname,
                            pageName: "Add Death Details",
                            data
                        }))} />
                    <Row>
                        <Col lg={12}>
