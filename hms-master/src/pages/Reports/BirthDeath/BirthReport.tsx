...
import BirthRateGraph from './BirthRateGraph'
...
const BirthReport = () => {
    ...
    const getAllPatientData = async () => {
        try {
            ...
            let result = await reportApiService.getBirthReport(url);
            setBirthReportData(result);
            return result || [];
        } catch (error: any) {
    ...
    const exportData = async () => {
        try {
            ...
            const url = `?${params.toString()}`;
            const result = await reportApiService.exportBirthReport(url); // should return a Blob
            ...
            link.href = objectURL;
            link.download = 'BirthReport.xlsx';
    ...
    return (
        <React.Fragment>
            <div>
                <h5 className="card-title mb-4">Birth Report</h5>
                <Row>
                    <Col lg={4}>
                        <div className="mb-3">
                    ...
                    <Col lg={12} className="px-0">
                        <Card id="inventoryIssueReport">
                            ...
                            <div className="card-body pt-0">
                                ...
                                <div>
                                    <TableContainer
                                        columns={birthReportColumns}
                                        data={birthReportData}
                                        isGlobalFilter={true}
