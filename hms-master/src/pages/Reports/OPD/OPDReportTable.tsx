...
const OPDDischargedPatientTable = () => {
    ...
    const getAllPatientData = async () => {
        try {
            ...
            const url = `opdReports?${params.toString()}`;
            let result = await reportApiService.getAllOpdReport(url);
            setOpdReportData(result);
            return result || [];
        } catch (error: any) {
    ...
    const exportData = async () => {
        try {
            ...
            const result = await reportApiService.exportOpdReport(url); // should return a Blob
    ...
    return (
        <React.Fragment>
            <div>
                <h5 className="card-title mb-4">OPD Report</h5>
