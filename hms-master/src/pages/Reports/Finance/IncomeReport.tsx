...
const IncomeReport = () => {
    ...
    const totalAmount = incomeReportData.reduce((sum: any, data: any) => sum + (data.totalAmount || 0), 0);
    ...
    const getAllPatientData = async () => {
        try {
            ...
            let result = await reportApiService.getAllIncomeReport(url);
    ...
    const exportData = async () => {
        try {
            ...
            const result = await reportApiService.exportIncomeReport(url); // should return a Blob
            ...
            link.href = objectURL;
            link.download = 'IncomeReport.xlsx';
    ...
    return (
        <React.Fragment>
            <div>
                <div>
                    <h5 className="card-title mb-4">Income Report</h5>
                </div>
                <Row>
                    <Col lg={4}>
                        <div className="mb-3">
