...
const MonthlyProfitAndLoss = () => {
    ...
    const getAllPatientData = async () => {
        try {
            ...
            let result = await reportApiService.getAllMonthlyProfitLossReport(url);
    ...
    const exportData = async () => {
        try {
            ...
            const result = await reportApiService.exportMonthlyProfitLossReport(url); // should return a Blob
