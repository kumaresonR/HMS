...
const InventoryIssueReport = () => {
    ...
    const getAllPatientData = async () => {
        try {
            ...
            let result = await reportApiService.getIssueItemReport(url);
    ...
    const exportData = async () => {
        try {
            ...
            link.href = objectURL;
            link.download = 'InventoryIssueReport.xlsx';
    ...
    return (
        <React.Fragment>
            <div>
                <h5 className="card-title mb-4">Inventory Issue Report</h5>
                <Row>
                    <Col lg={4}>
                        <div className="mb-3">
