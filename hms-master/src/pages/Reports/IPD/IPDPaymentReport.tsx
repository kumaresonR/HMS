...
const IPDPaymentReport = () => {
    ...
    const [opdReportData, setIpdReportData] = useState([]);
    ...
    const getAllPatientData = async () => {
        try {
            ...
            let result = await reportApiService.getAllIpdPaymentReport(url);
            setIpdReportData(result.content);
    ...
    const exportData = async () => {
        try {
            ...
            const result = await reportApiService.exportIPDPaymentReport(url); // should return a Blob
            ...
            link.href = objectURL;
            link.download = 'IPDPaymentReport.xlsx';
    ...
    return (
        <React.Fragment>
            <div>
                <h5 className="card-title mb-4">IPD Payments</h5>
...
export default IPDPaymentReport