  ...
  const reportApiService: ReportApiService = new ReportApiService();
    ...
    const getAllPatientData = async () => {
        try {
            ...
            let result = await reportApiService.getAllIpdChargesReport(url);
    ...
    const exportData = async () => {
        try {
            ...
            const result = await reportApiService.exportIPDChargesReport(url); // should return a Blob
            ...
            link.href = objectURL;
            link.download = 'IPDChargesReport.xlsx';
...
export default IpdChargesReport