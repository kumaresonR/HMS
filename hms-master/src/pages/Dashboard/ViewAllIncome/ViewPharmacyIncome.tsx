...
const ViewPharmacyIncome = () => {
    ...
    const getAllIncome = async (selectedFilter: any) => {
        try {
            ...
            let ipdIncome = await dashboardApiService.viewAllPharmacyIncome(url);
            setData(ipdIncome)
        } catch (error: any) {
            console.log(error);
            setData([])
                                    ...
                                    <Table hover className="table-centered table-bordered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            {data?.map((data: any, idx: any) => (
                                                <tr key={idx}>
                                                    <td className="text-primary">{data.billNo || 'NA'}</td>
...
export default ViewPharmacyIncome