...
const AddPathologyCategory = () => {
    ...
    const createCategory = async () => {
        try {
            ...
            await setupApiService.createPathologyCategory(payload);
            navigate('/main/PathologyMainSetup');
            toast.success('Category Details Added Successfully', { containerId: 'TR' });
        } catch (error: any) {
...
export default AddPathologyCategory;
