...
const EditPathologyCategory = () => {
    ...
    const handleSubmit = (event: any) => {
        ...
        if (validateForm()) {
            editPathologyCategory();
        }
    }
    const editPathologyCategory = async () => {
        try {
            const payload: any = {
                // modNo: modNo,
                categoryName: name,
            }
            await setupApiService.editPathologyCategory(data.id,payload);
...
export default EditPathologyCategory;