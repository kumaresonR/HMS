...
const AddSpecialist = () => {
  ...
  const createSpecialist = async () => {
      try {
          ...
          await setupApiService.createSpecialist(payload);
          navigate('/main/humanResourceMainSetup');
          toast.success('Specialist Added Successfully', { containerId: 'TR' });
      } catch (error: any) {
  ...
  return (
      <React.Fragment>
          <div>
              <Container fluid>
                  <FormHeader title="Add Specialist" pageTitle="Setup" />
                  <Card>
                      <CardBody>
