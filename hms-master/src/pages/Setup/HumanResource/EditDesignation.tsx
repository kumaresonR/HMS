...
const EditDesignation = () => {
    ...
    const createDesignation = async () => {
        try {
            ...
            await setupApiService.editDesignation(data.designationId, payload);
            navigate('/main/humanResourceMainSetup');
            toast.success('Designation Updated Successfully', { containerId: 'TR' });
        } catch (error: any) {
    ...
    return (
        <React.Fragment>
            <div>
                <Container fluid>
                    <FormHeader title="Edit Designation" pageTitle="Setup" />
                    <Card>
                        <CardBody>
