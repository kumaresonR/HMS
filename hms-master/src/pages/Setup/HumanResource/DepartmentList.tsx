...
const DepartmentList = () => {
    ...
    const departmentColumns = [
        ...
        //         const departmentHead = cell.row.original.employeeId;
        //         return (
        //             <ul className="list-inline hstack gap-2 mb-0">
        //                 <li>{cell.row.original.employeeFirstName}</li>
        //                 {status === "UNAUTHORIZED" && (!departmentHead || departmentHead.trim() === "") ? (
        //                     <>
        //                         <li className="list-inline-item">
        //                             <Badge
        //                                 className="edit-item-btn pointer"
        //                                 onClick={(e) => {
        //                                     e.preventDefault();
        //                                     addDepartmentHead(cell.row.original)
        //                                 }}
        //                             >
        //                                 Add Department Head
        //                             </Badge>
        ...
        // },
        {
            ...
            cell: (cell: any) => {
                ...
                const handleAuthorize = () => {
                    ...
                    doApprove(cell.row.original.departmentId, newStatus);
                };
                            ...
                            <>
                                <li className="list-inline-item">
                                    <Link
                                        ...
                                        onClick={(e) => {
                                            e.preventDefault();
                                            editDepartment(cell.row.original)
                                        }}
                                        title="Edit"
                                    >
                                ...
                                <li className="list-inline-item" title="Delete">
                                    <Link
                                        ...
                                        onClick={(e) => {
                                            e.preventDefault();
                                            deleteDepartment(cell.row.original.departmentId);
                                        }}
                                        to="#"
                                    >
        ...
        if (selectedDepartmentId) {
            ...
            try {
                if (status === "AUTHORIZED") {
                    await setupApiService.approveDepartment(selectedDepartmentId);
                    toast.success('Record has been Authorized Successfully', { containerId: 'TR' });
                } else {
                    await setupApiService.disApproveDepartment(selectedDepartmentId);
    ...
    const editDepartment = (data: any) => {
        navigate('/main/editDepartment', { state: { data: data } })
    }

    const addDepartmentHead = (data: any) => {
    ...
    const handleDelete = async () => {
        if (selectedId) {
            try {
                await setupApiService.deleteDepartment(selectedId);
    ...
    const getAllDepartment = async () => {
        try {
            let result = await setupApiService.getAllDepartment();
                                            ...
                                            <CardHeader className="border-0">
                                                <Row className="g-4 align-items-center">
                                                    ...
                                                    <div className="col-sm-auto">
                                                        <div>
                                                            <Link to='/main/addDepartment'>
                                                                <Button
                                                                    size="sm"
                                                                    color="primary"
                                                                    className="btn btn-primary add-btn me-3"
                                                                >
                                                                    <i className="ri-add-fill me-1 align-bottom"></i> Add New Department
                                                                </Button>
                                                            </Link>
                                                            <Button
                                                                type="button"
