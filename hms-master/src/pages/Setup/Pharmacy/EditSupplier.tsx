...
const EditPharmacySupplier = () => {
    ...
    const editSupplier = async () => {
        try {
            ...
            await setupApiService.editSupplier(data.supplierId, payload);
            navigate('/main/pharmacyMainSetup');
            toast.success('Supplier Details Updated Successfully', { containerId: 'TR' });
        } catch (error: any) {
    ...
    useEffect(() => {
        if (state?.data) {
            ...
            setDrugLicenseNumber(data.drugLicenceNumber);
    ...
    return (
        <React.Fragment>
            <div>
                <Container fluid>
                    <FormHeader title="Edit Supplier" pageTitle="Setup" />
                    <Card>
                        <CardBody>
                                ...
                                <Col xl={12}>
                                    <Form onSubmit={handleSubmit}>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <FormGroup>
                                                    <Label for="contactPersonPhone">Contact Person Phone <span className='text-danger'> * </span></Label>
                                                    <Input
                                                        type="text"
...
export default EditPharmacySupplier;