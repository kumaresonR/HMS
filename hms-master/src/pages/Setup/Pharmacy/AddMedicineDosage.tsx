...
const AddMedicineDosage = () => {
    ...
    const createMedicineDosage = async () => {
        try {
            ...
            await setupApiService.createMedicineDosage(payload);
            navigate('/main/pharmacyMainSetup');
            toast.success('Dosage Added Successfully', { containerId: 'TR' });
        } catch (error: any) {
    ...
    return (
        <Container fluid>
            <FormHeader title="Add Medicine Dosage" pageTitle="Setup" />
            <Card>
                <CardBody>
