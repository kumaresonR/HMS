...
const MedicineCategoryList = () => {
        ...
        if (selectedCategoryId) {
            ...
            try {
                if (status === "AUTHORIZED") {
                    await setupApiService.approveMedicineCategory(selectedCategoryId);
                    toast.success('Record has been Authorized Successfully', { containerId: 'TR' });
                } else {
                    await setupApiService.disApproveMedicineCategory(selectedCategoryId);
    ...
    const editCategory = (data: any) => {
        navigate('/main/editMedicineCategory', { state: { data: data } })
    }
    ...
    const handleDelete = async () => {
        if (selectedId) {
            try {
                await setupApiService.deleteMedicineCategory(selectedId);
    ...
    const getAllMedicineCategory = async () => {
        try {
            let result = await setupApiService.getAllMedicineCategoryWorkTable();
                                            ...
                                            <CardHeader className="border-0">
                                                <Row className="g-4 align-items-center">
                                                    ...
                                                    <div className="col-sm-auto">
                                                        <div>
                                                            <Link to='/main/addMedicineCategory'>
                                                                <Button
                                                                    size="sm"
                                                                    color="primary"
