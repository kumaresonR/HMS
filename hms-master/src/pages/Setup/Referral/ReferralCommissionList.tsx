...
const ReferralCommissionList = () => {
    ...
    const referralCommissionColumns = [
        {
            header: 'Category',
            accessorFn: (row:any) => row.referralCategory?.name || 'N/A',
            enableColumnFilter: false,
        },
        {
            header: 'Module - Commission',
        ...
        },
        {
            ...
            cell: (cell: any) => {
                ...
                const handleAuthorize = () => {
                    ...
                    doApprove(cell.row.original.commissionId, newStatus);
                };
                            ...
                            <>
                                ...
                                <li className="list-inline-item" title="Delete">
                                    <Link
                                        ...
                                        onClick={(e) => {
                                            e.preventDefault();
                                            deleteCommission(cell.row.original.commissionId);
                                        }}
                                        to="#"
                                    >
    ...
    const handleApprove = async () => {
        if (selectedCommissionId) {
            try {
                ...
                await setupApiService.approveReferralCommission(selectedCommissionId, url);
    ...
    const editReferral = (data: any) => {
        navigate('/main/editReferralCommission', { state: { data: data } })
    }
    ...
    const handleDelete = async () => {
        if (selectedId) {
            try {
                await setupApiService.deleteCommission(selectedId);
    ...
    const getAllCommission = async () => {
        try {
            let result = await setupApiService.getAllReferralCommissionWt();
                    ...
                    <Row className="d-flex justify-content-center">
                        <Col xl={12} className="p-0">
                            <Card>
                                ...
                                <Row>
                                    <Col lg={12}>
                                        <Card id="referralCommissionList">
                                            <CardHeader className="border-0">
                                                <Row className="g-4 align-items-center">
                                                    <div className="col-sm">
                                                        <div>
                                                            <h5 className="card-title mb-0">Referral Commission List</h5>
                                                        </div>
                                                    </div>
                                                    <div className="col-sm-auto">
                                                        <div>
                                                            <Link to='/main/addReferralCommission'>
                                                                <Button
                                                                    size="sm"
                                                                    color="primary"
                                                                    className="btn btn-primary add-btn me-3"
                                                                >
                                                                    <i className="ri-add-fill me-1 align-bottom"></i> Add New Commission
                                                                </Button>
                                                            </Link>
                                                            <Button
                                                                type="button"
                                            ...
                                            <div className="card-body pt-0">
                                                <div>
                                                    <TableContainer
                                                        columns={referralCommissionColumns}
                                                        data={commissionData}
                                                        isGlobalFilter={true}
