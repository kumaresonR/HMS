...
import ReferralCommissionList from './ReferralCommissionList';
import ReferralCategoryList from './ReferralCategoryList';
                                    ...
                                    <Card>
                                        <CardBody>
                                            <Nav className="flex-column custom-nav nav-pills">
                                                {[
                                                    { id: 1, label: "Referral Commission List" },
                                                    { id: 2, label: "Category" },
                                                ].map((tab) => (
                                                    <NavItem key={tab.id}>
                                                        <NavLink
