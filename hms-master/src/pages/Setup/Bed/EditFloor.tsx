...
const EditFloor = () => {
    ...
    const createFloor = async () => {
        try {
            ...
            await setupApiService.editFloor(id, payload);
            navigate('/main/bedMain');
            toast.success('Floor Details Updated Successfully', { containerId: 'TR' });
        } catch (error: any) {
    ...
    return (
        <React.Fragment>
            <div>
                <Container fluid>
                    <FormHeader title="Edit Floor" pageTitle="Setup" />
                    <Card>
