...
const EditExpense = () => {
    ...
    const editExpenceRecord = async () => {
        try {
            ...
            await financeApiService.editExpenses(id, formData);
            toast.success('Expence Updated Successfully', { containerId: 'TR' });
    ...
    const getExpenseById = async () => {
        try {
            let result = await financeApiService.getExpensesById(id);
            setData(result);
        } catch (error: any) {
            return ErrorHandler(error)
        }
    ...
    const setData = (data: any) => {
        setIncomeHead(data.expenseHead || data.incomeHead);
        setName(data.name);
        setInvoiceNumber(data.invoiceNumber);
        setDate(moment(data.date).format('YYYY-MM-DD') || data.date);
                            ...
                            <Row className="d-flex justify-content-center">
                                <Col xl={12}>
                                    ...
                                    <div className="d-flex justify-content-between align-items-center mb-3">
                                        <h5 className="mb-0">Edit Expense Details</h5>
                                    ...
                                    <Form onSubmit={handleSubmit}>
                                        ...
                                        <Button type="submit" color="primary">Update Expense</Button>
                                    </Form>
                                </Col>
                            </Row>
                        </CardBody>
