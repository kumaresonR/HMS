...
const EditRadiologyTestDetails = (props: any) => {
    const billingApiService: BillingApiService = new BillingApiService();
    const setupApiService: SetupApiService = new SetupApiService();

    const id = props.data.radiologyTestId;
    ...
    const doCreateTestData = async () => {
        try {
            ...
            await billingApiService.editRadiologyTest(id, payload);
            toast.success('Radilology Test Created Successfully', { containerId: 'TR' });
            props.handleClose();
            props.refresh();
        } catch (error: any) {
            console.log("Radilology Test Created Failed", error);
            return ErrorHandler(error)
        }
    }

    const getRadilologyById = async () => {
        try {
            let data = await billingApiService.getRadiologyTest(id);
            setData(data);
            console.log('getRadilologyById data', data);
        } catch (error) {
            console.log(error);
        }
...
export default EditRadiologyTestDetails