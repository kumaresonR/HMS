...
const BloodDonorDetails = (props: any) => {
    ...
    const validateForm = () => {
        ...
        if (!bloodDonor) {
            setBloodDonorValidationError(true);
            isFormValid = false;
        }
    ...
    const doCreateDonorDetails = async () => {
        try {
            ...
            await bloodBankApiService.CreateBloodDonor(formData);
        ...
        <Container fluid>
            <Form onSubmit={handleSubmit}>
                <Row>
                    <Col>
                        <FormGroup>
                            <label className="text-start mb-2">Blood Donor<span className="text-danger">*</span></label>
                            <select id="bloodDonor"
                                className={`form-control ${bloodDonorValidationError ? 'is-invalid' : ''}`}
                                value={bloodDonor}
                                onChange={(e) => { handleBloodDonorChange(e.target.value) }}
                            >
                            ...
                            {bloodDonorValidationError && <div className="invalid-feedback">Blood Donor Required.</div>}
                        </FormGroup>
                    </Col>
                    <Col>
                        <FormGroup>
