...
import { Button, Card, CardBody, CardHeader, Col, Container, Form, FormGroup, Input, Modal, ModalBody, ModalHeader, Row, Table } from 'reactstrap';
...
const AddMedicine = (props: any) => {
    ...
    const addMedicineDetails = async () => {
        try {
            ...
            await pharmacyApiService.createMedicineStock(formData);
            toast.success('Medicine Details Saved Successfully', { containerId: 'TR' });
            props.handleMedicineColse()
        } catch (error: any) {
