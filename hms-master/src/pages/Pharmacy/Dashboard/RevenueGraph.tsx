...
const RevenueCharts = ({ chartId, series = [] }: any) => { // Set default empty array for series
  const chartColors = useChartColors(chartId) || ['#FF4560', '#008FFB', '#00E396']; // Fallback to default colors if undefined
