...
import { changeLayout, changeLayoutMode, changeLayoutPosition, changeLayoutWidth, changeLeftsidebarSizeType, changeLeftsidebarViewType, changePreLoader, changeSidebarImageType, changeSidebarTheme, changeSidebarVisibility, changeTopbarTheme } from '../../slices/thunks';
import { LAYOUT_MODE_TYPES, LAYOUT_POSITION_TYPES, LAYOUT_SIDEBAR_TYPES, LAYOUT_TOPBAR_THEME_TYPES, LAYOUT_TYPES, LAYOUT_WIDTH_TYPES, LEFT_SIDEBAR_IMAGE_TYPES, LEFT_SIDEBAR_SIZE_TYPES, LEFT_SIDEBAR_VIEW_TYPES,  PERLOADER_TYPES,  SIDEBAR_VISIBILITY_TYPES } from '../constants/layout';
