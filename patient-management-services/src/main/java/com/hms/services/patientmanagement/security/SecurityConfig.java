package com.hms.services.patientmanagement.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers(HttpMethod.PATCH,"/patients/old-prescription/*").permitAll()
                        // Allow service-to-service calls (used by other microservices)
                        .requestMatchers(HttpMethod.GET, "/patients/{patientId}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/patients/getPatientData/searchTerm").permitAll()
