...
public interface PostalReceiveMapper {
    ...
    PostalReceive entityToDto(HMS_TM_Postal_Receive hmsTmPostalReceive);
    ...
    HMS_TM_Postal_Receive dtoToEntity(PostalReceive postalReceive);
