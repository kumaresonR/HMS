...
public interface PostalDispatchMapper {
    ...
    @Mapping(target = "to_title", source = "toTitle" )
    @Mapping(target = "ref_no", source = "referenceNumber" )
    @Mapping(target = "from_title", source = "fromTitle" )
    @Mapping(target = "id", source = "id", qualifiedByName = "uuidToString")
    PostalDispatch entityToDto(HMS_TM_Postal_Dispatch hmsTmPostalDispatch);


    @Mapping(target = "fromTitle", source = "from_title" )
    @Mapping(target = "toTitle", source = "to_title" )
    @Mapping(target = "referenceNumber", source = "ref_no" )
    ...
    HMS_TM_Postal_Dispatch dtoToEntity(PostalDispatch postalDispatch);
