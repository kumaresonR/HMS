package com.hms.services.tpamanagement.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/tpa-details/all").permitAll()
                        .requestMatchers("/tpa-details/*").permitAll()
                        // Restrict GET endpoints - only allow public endpoints
                        .requestMatchers(HttpMethod.GET, "/health", "/actuator/**", "/tpa-details/**").permitAll()
